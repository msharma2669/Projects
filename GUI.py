...
class RegistrationModule:
    def __init__(self):
        ...
        clientID = tk.Label(self.window, text="Client ID", width=10, height=1, fg="white", bg="#363e75", font=('times', 15))
        ...
        empID = tk.Label(self.window, text="EmpID", width=10, fg="white", bg="#363e75", height=1, font=('times', 15))
        ...
        empName = tk.Label(self.window, text="Emp Name", width=10, fg="white", bg="#363e75", height=1, font=('times', 15))
